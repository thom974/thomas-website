    ...
    return (
        ...
        >
            <Stack
                ...
                pb={53}
            >
                <svg className='logo' width="46" height="46" viewBox="0 0 46 46" fill="none">
                ...
                <svg className='logo' width="50" height="49" viewBox="0 0 50 49" fill="none">
                ...
                <svg className='logo' width="46" height="40" viewBox="0 0 46 40" fill="none">
